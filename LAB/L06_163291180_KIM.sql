...
(163291180, 'YeJin', 'Kim','yjkim33@myseneca.ca'),
(100897281, 'Daniel', 'Byun','dbyu11@myseneca.ca'),
(286138492, 'Sejin', 'Park','sjin23@myseneca.ca'),
(187329362,'Jihyang','Hong','jhang21@myseneca.ca');
...
ALTER TABLE mark
ADD CONSTRAINT mrk_fk FOREIGN KEY(markId) REFERENCES juncT(markId),
ADD CONSTRAINT std_fk FOREIGN KEY(stdId) REFERENCES juncT(stdId);
ALTER TABLE juncT
ADD CONSTRAINT mrk_fk FOREIGN KEY(markId) REFERENCES test(markId);
